 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.aemuser.components.helloworld;
...
out.write("\r\n    ");
_global_model = renderContext.call("use", com.aem.slack.core.models.HelloWorldModel.class.getName(), obj());
{
